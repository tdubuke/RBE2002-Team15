...
void myStepper::initStepper(int numSteps, int imotor_pin_1, int imotor_pin_2, int imotor_pin_3, int imotor_pin_4){
  this->step_number = 0;    // which step the motor is on
  this->direction = 0;      // motor direction
  this->last_step_time = 0; // time stamp in us of the last step taken
  this->number_of_steps = numSteps; // total number of steps for this motor

  // Arduino pins for the motor control connection:
  this->motor_pin_1 = imotor_pin_1;
  this->motor_pin_2 = imotor_pin_2;
  this->motor_pin_3 = imotor_pin_3;
  this->motor_pin_4 = imotor_pin_4;
